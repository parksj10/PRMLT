/*
 * hmmViterbi_emxutil.c
 *
 * Code generation for function 'hmmViterbi_emxutil'
 *
 */
...
{
  emxInit_real_T(sp, &pStruct->A, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->B, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->pi, 1, srcLocation, doPush);
}
...
/* End of code generation (hmmViterbi_emxutil.c) */
